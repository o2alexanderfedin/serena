    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                "Struct",
                "Model.kt",
                marks=[pytest.mark.kotlin, _REQUIRES_KOTLIN, pytest.mark.skip(reason="Kotlin LSP can't host multiple editing sessions per workspace; flakes both in CI and locally")],
            ),
