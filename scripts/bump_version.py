...
def bump_version(major: bool, minor: bool, patch: bool, target_version: str | None, dry_run: bool) -> None:
    ...
    new_version = bump_repo_version(repo_root, version_part=version_part, target_version=target_version, dry_run=dry_run, increment_patch=False)
    ...
    new_snapshot_version = bump_repo_version(
        repo_root, version_part="patch", target_version=None, dry_run=dry_run, target_version_suffix=".dev0", increment_patch=True,
    )
